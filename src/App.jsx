...
export default function App(){
  ...
  if(!selectedSite) return <div className="p-8 text-center">Loading 80 sites from main dashboard — open <a href="http://localhost:5174" className="underline">DHRE Security Dashboard</a> first.</div>
        ...
        <div className="flex-1 grid place-items-center p-4">
          <div className="w-full max-w-[480px] bg-white rounded-[24px] border shadow-xl p-6" style={{ borderColor:'#e2e8f0' }}>
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="text-xs text-center text-slate-500">Pincode is per-site • <a href="http://localhost:5174" className="underline font-bold">Back to main dashboard</a></div>
            </div>
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <header className="sticky top-0 z-30 border-b overflow-hidden" style={{ borderColor: '#0f172a' }}>
        <div className="bg-gradient-to-r from-slate-900 via-slate-900 to-sky-900">
          <div className="max-w-[1280px] mx-auto px-4 lg:px-6 h-[64px] flex items-center justify-between gap-4">
            <a href="http://localhost:5174" className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="http://localhost:5174" className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white text-slate-900 text-xs font-bold hover:bg-slate-100 shadow"><ArrowLeft size={14} /> Dashboard</a>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-[1280px] mx-auto px-4 lg:px-6 py-6">
        ...
        <p className="mt-6 text-center text-xs text-slate-400">Owner Portal • Linked to main dashboard • Edits update main dashboard live (shared localStorage) • <a href="http://localhost:5174" className="underline font-bold">Back to DHRE Security Dashboard</a></p>
      </main>
